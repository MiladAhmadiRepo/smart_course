...
import 'package:smart_course/src/helper/courseModel.dart';
import 'package:smart_course/src/helper/quad_clipper.dart';
import 'package:smart_course/src/pages/home_page.dart';
import 'package:smart_course/src/theme/color/light_color.dart';
import 'package:smart_course/src/theme/theme.dart';
        ...
        child: Row(
          children: <Widget>[
            AspectRatio(
              aspectRatio: .7,
              child: _card(context,
                  primaryColor: background??Colors.white, backWidget: decoration),
            ),
            Expanded(
                child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
